...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_interface_language1 = QtWidgets.QLabel(parent=self.general_tab)
        self.label_interface_language1.setObjectName("label_interface_language1")
        self.general_grid_layout.addWidget(self.label_interface_language1, 15, 0, 1, 1)
        self.interface_language_cb1 = QtWidgets.QComboBox(parent=self.general_tab)
        self.interface_language_cb1.setObjectName("interface_language_cb1")
        self.interface_language_cb1.addItem("")
        self.interface_language_cb1.addItem("")
        self.general_grid_layout.addWidget(self.interface_language_cb1, 15, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.stt_engine_cb.setCurrentText(_translate("Dialog", "vosk-local"))
        self.stt_engine_cb.setItemText(0, _translate("Dialog", "vosk-local"))
        self.stt_engine_cb.setItemText(1, _translate("Dialog", "whisper-local"))
        self.stt_engine_cb.setItemText(2, _translate("Dialog", "whisper-docker"))
        self.stt_engine_cb.setItemText(3, _translate("Dialog", "google-cloud-speech"))
        self.stt_engine_cb.setItemText(4, _translate("Dialog", "openai-realtime"))
        ...
        self.label_interface_language1.setToolTip(_translate("Dialog", "<b>Interface Language</b><br>Language for the application interface."))
        self.label_interface_language1.setText(_translate("Dialog", "Interface language"))
        self.interface_language_cb1.setItemText(0, _translate("Dialog", "English"))
        self.interface_language_cb1.setItemText(1, _translate("Dialog", "Español"))
